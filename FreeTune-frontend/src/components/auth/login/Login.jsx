        ...
        <div className="bg-gray-800 rounded-2xl shadow-2xl overflow-hidden">
          <div className="p-8">
            ...
            >
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  >
                    <img
                      onClick={eyeClick}
                      src={`${showLoginPassword ? "eye" : "eye-slash"}.svg`}
                      alt={showLoginPassword ? "eye" : "eye-slash"}
              ...
              <Button
                type="submit"
                buttonStyle="w-full py-3 bg-linear-to-r from-purple-600 to-blue-600 text-white font-semibold rounded-lg hover:from-purple-700 hover:to-blue-700 transform hover:scale-105 transition-all"
                svgSrc={"/signin.svg"}
                svgAlt={"signin"}
                svgStyle={"mr-2"}
              >
